    ...
    <form data-action="submit-create" class="form card form-card">
      ...
      <div class="location-picker">
        <div class="location-picker-head">
          <span class="field-label">Escolha o ponto exato no mapa</span>
          <button type="button" class="btn btn-outline btn-sm" data-action="use-current-location">Usar minha localização</button>
        </div>
        <div id="location-map" class="location-map" aria-label="Mapa para escolher a localização da denúncia"></div>
        <p class="location-hint">Clique no mapa para posicionar o marcador. O endereço será preenchido automaticamente quando disponível.</p>
      </div>
      <label class="field">
        <span>Descrição*</span>
